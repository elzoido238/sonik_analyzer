...
///
#ifndef SONIK_CONSTANTS_HXX
#define SONIK_CONSTANTS_HXX
...
/*! Example use:
 *  \code
 *  std::cout << "The electron charge in coulombs is: " << sonik::Constants::ElectronCharge() << "\n";
 *  \endcode
 ...
 *
 *  \Attention Future developers: if more constnats are needed, please extend this file rather than
